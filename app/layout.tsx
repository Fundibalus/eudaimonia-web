...
export const metadata: Metadata = {
  ...
  title: {
    default: "EUDAIMONIA — Feel Free. Feel Safe. | München 03.10.26",
    template: "%s | EUDAIMONIA",
  },
  description:
    "EUDAIMONIA — queere Clubnacht in München. Queer & FLINTA* friendly, Awareness Concept, Safe Space. 3. Oktober 2026, 23 Uhr, Nachtwerk Club München.",
  keywords: [
    "EUDAIMONIA",
  ...
  openGraph: {
    ...
    description: "3. Oktober 2026 · 23 Uhr · Nachtwerk Club München. Queer & FLINTA* friendly.",
    url: "https://eudaimonia-event.de",
    siteName: "EUDAIMONIA",
    images: [{ url: "/flyer.png", width: 1200, height: 630, alt: "EUDAIMONIA Flyer 03.10.2026" }],
    locale: "de_DE",
    type: "website",
  },
  twitter: {
    ...
    title: "EUDAIMONIA — Feel Free. Feel Safe.",
    description: "3. Oktober 2026 · 23 Uhr · Nachtwerk Club München.",
    images: ["/flyer.png"],
  },
  robots: {
    index: true,
