...
export const metadata: Metadata = {
  ...
  description:
    "EUDAIMONIA — queere Clubnacht in München. Queer & FLINTA* friendly, Awareness Concept, Safe Space. 3. Oktober 2026, 22 Uhr, Nachtwerk Club München.",
  keywords: [
    "EUDAIMONIA",
  ...
  openGraph: {
    ...
    description: "3. Oktober 2026 · 22 Uhr · Nachtwerk Club München. Queer & FLINTA* friendly.",
  ...
  twitter: {
    ...
    title: "EUDAIMONIA — Feel Free. Feel Safe.",
    description: "3. Oktober 2026 · 22 Uhr · Nachtwerk Club München.",
    images: ["/flyer.png"],
  },
  robots: {
    index: true,
